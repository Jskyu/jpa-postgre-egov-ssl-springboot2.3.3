...
public class JPAConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        //dialect 를 PostgreSQL10Dialect 로 주입한다.
        factory.getJpaPropertyMap().put("hibernate.dialect", PostgreSQL10Dialect.class.getName());
//        factory.getJpaPropertyMap().put("hibernate.dialect", Oracle10gDialect.class.getName()); //Tibero, Mysql
//        factory.getJpaPropertyMap().put("hibernate.dialect", MariaDB10Dialect.class.getName()); //Maria
